(function () {
  ...
  var icons = {
    mail: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:block;width:16px;height:16px;flex-shrink:0;"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>',
    phone:
    ...
    mapPin:
      '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:block;width:16px;height:16px;flex-shrink:0;"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path><circle cx="12" cy="10" r="3"></circle></svg>',
    whatsapp:
  ...
  function renderFooter() {
    ...
    "</nav></div>" +
    '<div><h2 class="text-xs font-semibold uppercase tracking-wider text-zinc-300">Blogs</h2>' +
    '<nav class="mt-4 flex flex-col" aria-label="Blogs">' +
    ...
    '<a href="how-to-ask-customers-for-google-reviews.html" class="block py-1 text-sm text-zinc-400 transition-colors hover:text-white">How to ask for Google reviews</a>' +
    '<a href="google-review-qr-code-ideas.html" class="block py-1 text-sm text-zinc-400 transition-colors hover:text-white">Google review QR code ideas</a>' +
    '<a href="handle-negative-google-reviews.html" class="block py-1 text-sm text-zinc-400 transition-colors hover:text-white">Handle negative Google reviews</a>' +
    "</nav></div>" +
    '<div><h2 class="text-xs font-semibold uppercase tracking-wider text-zinc-300">Contact</h2>' +
    '<div class="mt-4 flex flex-col gap-2">' +
    '<a href="mailto:support@amtechnexus.com" style="display:flex;align-items:center;gap:8px;" class="text-sm text-zinc-400 transition-colors hover:text-white">' +
    icons.mail +
    "<span>support@amtechnexus.com</span></a>" +
    '<a href="tel:+918807810394" style="display:flex;align-items:center;gap:8px;" class="text-sm text-zinc-400 transition-colors hover:text-white">' +
    icons.phone +
    "<span>+91 88078 10394</span></a>" +
    '<a href="tel:+917010762956" style="display:flex;align-items:center;gap:8px;" class="text-sm text-zinc-400 transition-colors hover:text-white">' +
    icons.phone +
    "<span>+91 70107 62956</span></a>" +
    '<a href="tel:+918072263675" style="display:flex;align-items:center;gap:8px;" class="text-sm text-zinc-400 transition-colors hover:text-white">' +
    icons.phone +
    "<span>+91 80722 63675</span></a>" +
    '<p style="display:flex;align-items:center;gap:8px;" class="text-sm text-zinc-400">' +
    icons.mapPin +
    "<span>Tamil Nadu, India</span></p>" +
    "</div></div></div>" +
